...
# Usage:
#   bash run_floam_ablations.sh
# Optional overrides:
#   EPOCHS=100 SEED=1 GPU=0 bash run_floam_ablations.sh
# Smoke test:
#   EPOCHS=2 SKIP_EVAL=1 bash run_floam_ablations.sh
...
echo "Summarize with: python distribution/collect_ablation_results.py --seed ${SEED}"
