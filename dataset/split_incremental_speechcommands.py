...
for client_id in range(num_client):
    ...
    for task in range(num_task):
        ...
        if task < remaining_classes:
            ...
            start_class += remaining_classes
            end_class += remaining_classes
...
print(f"Classes per task: {classes_per_task} (with {remaining_classes} tasks having one extra class)")
