...
# MOON on CIFAR-10 (5 tasks), GPU 1, 5 sequential runs.
# Usage:
#   nohup bash scripts/run_moon_cifar10_task5_5runs.sh > logs/moon_cifar10_task5/master.nohup.log 2>&1 &
...
echo "[$(date '+%F %T')] Start MOON CIFAR-10 task-5: ${NUM_RUNS} runs on GPU ${GPU_ID}"
